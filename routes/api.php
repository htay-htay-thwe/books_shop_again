...
use App\Http\Controllers\Api\realOrderController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('realOrder/{id}',[realOrderController::class,'realOrder']);
    Route::get('realOrder/history/{id}',[realOrderController::class,'realOrderHistory']);
